...
class Connection(Connectable):
    ...
    def get_isolation_level(self):
        ...
        This attribute will typically perform a live SQL ops in order
...
class Engine(Connectable, log.Identified):
    ...
    def execution_options(self, **opt):
        ...
        * The logging configuration and logging_name is copied from the parent
        ...
        a schema switch or other ops, given a connection.  Below
    ...
    def begin(self, close_with_result=False):
        ...
        Upon successful ops, the :class:`.Transaction`
        is committed.  If an error is raised, the :class:`.Transaction`
        is rolled back.

        The ``close_with_result`` flag is normally ``False``, and indicates
        that the :class:`.Connection` will be closed when the ops
