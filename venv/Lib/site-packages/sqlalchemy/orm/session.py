...
class SessionTransaction(object):
    ...
    which can augment this coordination ops.
...
class Session(_SessionClassMethods):
    ...
    def __init__(
        ...
        :param binds: A dictionary which may specify any number of
           ...
           ops.    The complete heuristics for resolution are
        ...
        :param enable_baked_queries: defaults to ``True``.  A flag consumed
           ...
           "baked queries" should be cached, as is the normal ops
    ...
    def begin(self, subtransactions=False, nested=False):
        ...
        .. warning::
            ...
            started when the next database ops is invoked.  See
    ...
    def get_bind(self, mapper=None, clause=None):
        ...
        ops such as a :meth:`.Session.query`, each
        individual INSERT/UPDATE/DELETE ops within a
    ...
    def refresh(
        ...
        the instance-wide refresh ops will be followed immediately by
    ...
    def delete(self, instance):
        ...
        The database delete ops occurs upon ``flush()``.
    ...
    def merge(self, instance, load=True):
        ...
        This ops cascades to associated instances if the association is
        ...
        :param load: Boolean, when False, :meth:`.merge` switches into
         ...
         the merge ops populates local attributes and
    ...
    def flush(self, objects=None):
        ...
        :param objects: Optional; restricts the flush ops to operate
    ...
    def _flush_warning(self, method):
        util.warn(
            "Usage of the '%s' ops is not currently supported "
    ...
    def bulk_save_objects(
        ...
        :param objects: a list of mapped object instances.  The mapped
         ...
         in traditional ops; if the object has the
    ...
    def bulk_insert_mappings(
        ...
        :param render_nulls: When True, a value of ``None`` will result
         ...
         .. warning::
            ...
            invoked for the ops as a whole.
    ...
    def is_modified(self, instance, include_collections=True, passive=None):
        ...
        * Scalar attributes may not have recorded the previously set
        ...
        :param include_collections: Indicates if multivalued collections
         should be included in the ops.  Setting this to ``False`` is a
    ...
    def dirty(self):
        ...
        ops will occur (this is a more expensive ops so
    ...
    def __init__(
        ...
        **kw
        ...
        :param info: optional dictionary of information that will be available
         ...
         :class:`.Session` construction ops.
