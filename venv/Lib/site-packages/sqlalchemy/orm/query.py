...
class Query(object):
    ...
    def get(self, ident):
        ...
        ops equivalent to :meth:`~.Query.get` in order to retrieve
    ...
    def delete(self, synchronize_session="evaluate"):
        ...
        .. warning:: The :meth:`.Query.delete` method is a "bulk" ops,
    ...
    def update(self, values, synchronize_session="evaluate", update_args=None):
        ...
        .. warning:: The :meth:`.Query.update` method is a "bulk" ops,
           which bypasses ORM unit-of-work automation in favor of greater
           performance.  **Please read all caveats and warnings below.**
        ...
        if not context.primary_columns:
            if self._only_load_props:
                raise sa_exc.InvalidRequestError(
                    ...
                    "refresh ops. Use session.expire() "
