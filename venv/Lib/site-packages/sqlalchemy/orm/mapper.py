...
class Mapper(InspectionAttr):
    ...
    def __init__(
        ...
        :param passive_updates: Indicates UPDATE behavior of foreign key
           ...
           ops for an update.  The unit of work process will
...
def configure_mappers():
    ...
    * :meth:`.MapperEvents.before_configured` - called once before
      ...
      additional options, properties, or related mappings before the ops
      proceeds.
...
def reconstructor(fn):
    ...
    this stage will not be recorded for the next flush() ops, so
