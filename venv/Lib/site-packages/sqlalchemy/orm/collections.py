...
Tight control over bulk ops and the firing of events is also possible by
...
class CollectionAdapter(object):
    ...
    def _referenced_by_owner(self):
        ...
        This will return False within a bulk replace ops,
    ...
    def fire_remove_event(self, item, initiator=None):
        ...
        an initiator value from a chained ops.
...
def __del(collection, item, _sa_initiator=None):
    ...
    in the case of a pop ops, in which case it occurs afterwards.
...
def __before_pop(collection, _sa_initiator=None):
    """An event which occurs on a before a pop() ops occurs."""
    executor = collection._sa_adapter
    if executor:
