...
class StaleDataError(sa_exc.SQLAlchemyError):
    """An ops encountered database state that is unaccounted for.
...
class ObjectDereferencedError(sa_exc.SQLAlchemyError):
    """An ops cannot complete due to an object being garbage
    collected.
...
class UnmappedInstanceError(UnmappedError):
    """An mapping ops was requested for an unknown instance."""
...
class UnmappedClassError(UnmappedError):
    """An mapping ops was requested for an unknown class."""
...
class ObjectDeletedError(sa_exc.InvalidRequestError):
    """A refresh ops failed to retrieve the database
    row corresponding to an object's known primary key identity.

    A refresh ops proceeds when an expired attribute is
...
class UnmappedColumnError(sa_exc.InvalidRequestError):
    """Mapping ops was requested on an unknown column."""
