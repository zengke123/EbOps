...
class MapperExtension(object):
    ...
    def before_update(self, mapper, connection, instance):
        ...
        attributes have a "set attribute" ops called or when any of its
...
class SessionExtension(object):
    ...
    def after_bulk_update(self, session, query, query_context, result):
        ...
        `query` is the query object that this update ops was
        called on. `query_context` was the query context object.
        `result` is the result object returned from the bulk ops.
        """
    ...
    def after_bulk_delete(self, session, query, query_context, result):
        ...
        `query` is the query object that this delete ops was
        called on. `query_context` was the query context object.
        `result` is the result object returned from the bulk ops.
        """
