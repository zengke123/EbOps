...
class MapperProperty(_MappedAttribute, InspectionAttr, util.MemoizedSlots):
    ...
    def post_instrument_class(self, mapper):
        ...
        The given Mapper is the Mapper invoking the ops, which
...
class MapperOption(object):
    ...
    def process_query_conditionally(self, query):
        ...
        ops to propagate options stated in the original Query to the
    ...
    def _generate_cache_key(self, path):
        ...
        produced during a lazy load ops for a mapped relationship.
        It does not yet apply to the "lazy" load ops for deferred
        ...
        load ops therefore needs to tell the baked loader that it either
...
class LoaderStrategy(object):
    ...
    * it controls the configuration of the ``InstrumentedAttribute``
      ...
      off a select ops when the attribute is first accessed
      (i.e. a lazy load)
