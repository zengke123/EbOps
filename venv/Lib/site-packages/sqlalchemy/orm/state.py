...
class InstanceState(interfaces.InspectionAttrInfo):
    ...
    """The set of keys which are 'expired' to be loaded by
       ...
       against this set when a refresh ops occurs."""
    ...
    def _commit(self, dict_, keys):
        ...
        This is used by a partial-attribute load ops to mark committed
...
class AttributeState(object):
    ...
    def value(self):
        ...
        This ops is equivalent to accessing the object's
