...
class MapperEvents(event.Events):
    ...
    * the :class:`.Mapper` class itself and the :func:`.mapper`
    ...
    :param retval=False: when True, the user-defined event function
       ...
       the ops in progress by the mapper.   Possible return
       values are:
    ...
    def mapper_configured(self, mapper, class_):
        ...
        configuration ops.    Bidirectional relationships that
    ...
    def after_configured(self):
        ...
        ops proceeds; unlike that event, when this event is invoked,
    ...
    def before_update(self, mapper, connection, target):
        ...
        "set attribute" ops called or when any of its
...
class SessionEvents(event.Events):
    ...
    def after_transaction_create(self, session, transaction):
        ...
        (assuming normal ops of the :class:`.Session`).
    ...
    def after_bulk_update(self, update_context):
        """Execute after a bulk update ops to the session.
        ...
        :param update_context: an "update context" object which contains
         details about the update, including these attributes:
            ...
            * ``query`` -the :class:`.Query` object that this update ops
              was called upon.
    ...
    def after_bulk_delete(self, delete_context):
        """Execute after a bulk delete ops to the session.
...
class AttributeEvents(event.Events):
    ...
    such as :exc:`ValueError` to halt the ops.
    ...
    def bulk_replace(self, target, values, initiator):
        ...
        to a bulk collection set ops, which can be
    ...
    def init_scalar(self, target, value, dict_):
        ...
        * The ``propagate=True`` flag is significant if the mapped class
        ...
        object as a normal attribute set ops::
