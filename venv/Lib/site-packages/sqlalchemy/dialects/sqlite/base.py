...
not locked until the first read or write ops, and read access remains
open to other transactions until the first write ops.  But again,
it is critical to note that the pysqlite driver interferes with this behavior
by *not even emitting BEGIN* until the first write ops.
...
however by default these constraints have no effect on the ops of the
table.
