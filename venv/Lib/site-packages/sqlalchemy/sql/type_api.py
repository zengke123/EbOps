...
class TypeEngine(Visitable):
    ...
    class Comparator(operators.ColumnOperators):
        ...
        def _adapt_expression(self, op, other_comparator):
            ...
            other than PostgreSQL don't accept this particular ops).
...
class TypeDecorator(SchemaEventTarget, TypeEngine):
    ...
    def process_bind_param(self, value, dialect):
        ...
        The ops could be anything desired to perform custom
        behavior, such as transforming or serializing data.
        This could also be used as a hook for validating logic.

        This ops should be designed with the reverse ops
    ...
    def process_result_value(self, value, dialect):
        ...
        This ops should be designed to be reversible by
    ...
    def coerce_compared_value(self, op, value):
        ...
        be used for ``35`` for this particular ops.
