...
def literal(value, type_=None):
    ...
    used in a comparison ops with a :class:`.ColumnElement` subclass,
...
class ClauseElement(Visitable):
    ...
    def _copy_internals(self, clone=_clone, **kw):
        ...
        Called during a copy-and-traverse ops on newly
...
class BindParameter(ColumnElement):
    ...
    def __init__(
        ...
        :param key:
          ...
          value may be modified when part of a compilation ops,
...
class False_(ColumnElement):
    ...
    def _instance(cls):
        ...
        "short circuit" ops within an :func:`.and_` or :func:`.or_`
        conjunction::
...
class BooleanClauseList(ClauseList, ColumnElement):
    ...
    def and_(cls, *clauses):
        ...
        The :func:`.and_` ops is also implicit in some cases;
...
class UnaryExpression(ColumnElement):
    ...
    def _create_desc(cls, column):
        ...
        :param column: A :class:`.ColumnElement` (e.g. scalar SQL expression)
         with which to apply the :func:`.desc` ops.
    ...
    def _create_asc(cls, column):
        ...
        :param column: A :class:`.ColumnElement` (e.g. scalar SQL expression)
         with which to apply the :func:`.asc` ops.
...
class IndexExpression(BinaryExpression):
    """Represent the class of expressions that are like an "index" ops.
    """
