...
class Operators(object):
    ...
    def operate(self, op, *other, **kwargs):
        ...
        This is the lowest level of ops, raises
        ...
        :param \*other: the 'other' side of the ops. Will
...
class custom_op(object):
    ...
    to represent the "factorial" ops::
...
class ColumnOperators(Operators):
    ...
    so that the ``==`` ops above is replaced by a clause
    construct.
