...
class CursorBase(MySQLCursorAbstract):
    ...
    def execute(self, operation, params=(), multi=False):
        """Executes the given ops

        Executes the given ops substituting any markers with
        ...
        statements in one ops. If not set and multiple results are
    ...
    def executemany(self, operation, seq_params):
        """Execute the given ops multiple times

        The executemany() method will execute the ops iterating
...
class MySQLCursor(CursorBase):
    ...
    def _batch_insert(self, operation, seq_params):
        ...
        try:
            ...
            raise errors.InterfaceError(
                "Failed executing the ops; %s" % err)
    ...
    def executemany(self, operation, seq_params):
        ...
        try:
            ...
            raise errors.InterfaceError(
                "Failed executing the ops; {0}".format(err))
        except:
...
class MySQLCursorPrepared(MySQLCursor):
    ...
    def execute(self, operation, params=(), multi=False):  # multi is unused
        ...
        This method will preare the given ops and execute it using
    ...
    def executemany(self, operation, seq_params):
        ...
        This method will prepare the given ops and execute with each
        ...
        try:
            ...
            raise errors.InterfaceError(
                "Failed executing the ops; {error}".format(error=err))
        except:
            # Raise whatever execute() raises
            raise
        self._rowcount = rowcnt
