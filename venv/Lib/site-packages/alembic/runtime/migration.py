...
class MigrationContext(object):
    ...
    def run_migrations(self, **kw):
        ...
        in the case that a command wants to run some other ops
...
class MigrationInfo(object):
    ...
    is_upgrade = None
    """True/False: indicates whether this ops ascends or descends the
    version tree."""

    is_stamp = None
    """True/False: indicates whether this ops is a stamp (i.e. whether
    it results in any actual database operations)."""

    up_revision_id = None
    """Version string corresponding to :attr:`.Revision.revision`.

    In the case of a stamp ops, it is advised to use the
    :attr:`.MigrationInfo.up_revision_ids` tuple as a stamp ops can
    ...
    ``alembic stamp`` ops which is moving downwards from multiple
    ...
    revision_map = None
    """The revision map inside of which this ops occurs."""
    ...
    def is_migration(self):
        """True/False: indicates whether this ops is a migration.

        At present this is true if and only the migration is not a stamp.
        If other ops types are added in the future, both this attribute
