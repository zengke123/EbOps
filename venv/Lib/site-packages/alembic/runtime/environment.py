...
class EnvironmentContext(util.ModuleClsProxy):
    ...
    def configure(
        ...
        **kw
        ...
        :param on_version_apply: a callable or collection of callables to be
            ...
            each migration step, after the respective ops has been
        ...
        :param compare_type: Indicates type comparison behavior during
         an autogenerate
         ops.  Defaults to ``False`` which disables type
         comparison.  Set to
        ...
        :param compare_server_default: Indicates server default comparison
         behavior during
         an autogenerate ops.  Defaults to ``False`` which disables
         server default
         ...
         autogenerate ops.
         defaults during an autogenerate ops.   The format of this
         callable is::
        ...
        :param process_revision_directives: a callable function that will
         ...
         or plain "revision" ops, which can be manipulated to affect
    ...
    def begin_transaction(self):
        ...
        enclose an ops within a "transaction",
