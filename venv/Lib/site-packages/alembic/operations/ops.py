...
class MigrateOperation(object):
    ...
    This system is part of the ops extensibility API.
...
class AddConstraintOp(MigrateOperation):
    """Represent an add constraint ops."""
...
class DropConstraintOp(MigrateOperation):
    """Represent a drop constraint ops."""
...
class CreatePrimaryKeyOp(AddConstraintOp):
    """Represent a create primary key ops."""
...
class CreateUniqueConstraintOp(AddConstraintOp):
    """Represent a create unique constraint ops."""
...
class CreateForeignKeyOp(AddConstraintOp):
    """Represent a create foreign key constraint ops."""
...
class CreateCheckConstraintOp(AddConstraintOp):
    """Represent a create check constraint ops."""
...
class DropIndexOp(MigrateOperation):
    ...
    def reverse(self):
        if self._orig_index is None:
            raise ValueError(
                "ops is not reversible; " "original index is not present"
            )
...
class DropTableOp(MigrateOperation):
    ...
    def reverse(self):
        if self._orig_table is None:
            raise ValueError(
                "ops is not reversible; " "original table is not present"
            )
...
class CreateTableCommentOp(AlterTableOp):
    """Represent a COMMENT ON `table` ops.
    """
    ...
    def create_table_comment(
        ...
        """Emit a COMMENT ON ops to set the comment for a table.
        ...
        :param existing_comment: String value of a comment
         ...
         so that the ops is reversible, but not required for direct
         use.
    ...
    def reverse(self):
        """Reverses the COMMENT ON ops against a table.
        """
...
class DropTableCommentOp(AlterTableOp):
    """Represent an ops to remove the comment from a table.
    """
    ...
    def drop_table_comment(
        ...
        """Issue a "drop table comment" ops to
    ...
    def alter_column(
        ...
        **kw
        ...
        :param column_name: string name of the target column,
         as it exists before the ops begins.
        ...
        :param new_column_name: Optional; specify a string name here to
         indicate the new name within a column rename ops.
...
class BulkInsertOp(MigrateOperation):
    ...
    def bulk_insert(cls, operations, table, rows, multiinsert=True):
        """Issue a "bulk insert" ops using the current
        migration context.
...
class OpContainer(MigrateOperation):
    """Represent a sequence of operations ops."""
...
class MigrationScript(MigrateOperation):
    ...
    In the case of an autogenerate ops that runs multiple times,
    ...
    def upgrade_ops_list(self):
        ...
        attribute when dealing with a revision ops that does
