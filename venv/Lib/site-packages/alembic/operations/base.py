...
class Operations(util.ModuleClsProxy):
    ...
    Each ops corresponds to some schema migration ops,
    ...
    def register_operation(cls, name, sourcename=None):
        """Register a new ops for this class.
    ...
    def implementation_for(cls, op_cls):
        ...
        This is part of the ops extensibility API.
    ...
    def batch_alter_table(
        ...
        ops on other backends will proceed using standard ALTER TABLE
        operations.
        ...
        The copy ops by default uses reflection to retrieve the current
        ...
        .. note::  The table copy ops will currently not copy
...
class BatchOperations(Operations):
    ...
    def _noop(self, operation):
        raise NotImplementedError(
            "The %s method does not apply to a batch table alter ops."
            % operation
        )
