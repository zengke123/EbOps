...
_UPDATEOPERATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ops', full_name='Mysqlx.Crud.UpdateOperation.ops', index=1,
...
_UPDATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ops', full_name='Mysqlx.Crud.Update.ops', index=5,
      number=7, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATEOPERATION.fields_by_name['ops'].enum_type = _UPDATEOPERATION_UPDATETYPE
...
_UPDATE.fields_by_name['ops'].message_type = _UPDATEOPERATION
